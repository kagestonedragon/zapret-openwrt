...
return baseclass.extend({
    ...
    presetsDir        : '/opt/zapret/presets',
    presetsUserDir    : '/opt/zapret/presets/user',
    fakeDir           : '/opt/zapret/files/fake',
    ...
    listCatalog       : [
        ...
        { sid: 'fs_exclude',       type: 'hostlist', file: 'flowseal-exclude.txt',
        ...
        { sid: 'fs_ipset_all',     type: 'ipset',    file: 'flowseal-ipset-all.txt',
          name: 'Flowseal: ipset-all',
          url : 'https://raw.githubusercontent.com/Flowseal/zapret-discord-youtube/main/.service/ipset-service.txt' },
        { sid: 'fs_ipset_exclude', type: 'ipset',    file: 'flowseal-ipset-exclude.txt',
